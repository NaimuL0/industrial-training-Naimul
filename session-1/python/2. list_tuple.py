...
# Write your code below:
my_tuple = (1, "Hello", 3.14, True, [1, 2, 3], {"name": "Mohammad Naimul Islam", "age": 24, "city": "Chattogram", "country": "Bangladesh"})
print(my_tuple)
...
# Write your code below:
student_grades = [("Alice", 90), ("Bob", 85), ("Charlie", 95), ("David", 80), ("Eve", 100), ("Frank", 75), ("Naimul", 95)]
