...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        # Insert reporters
        insert_reporter(conn, "naimul", "naimul@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "sayem", "sayem@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "Rahim", "rahim@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "Karim", "karim@ugrad.iiuc.ac.bd")
        insert_reporter(conn, "Dudipto", "udipto@ugrad.iiuc.ac.bd")
        ...
        conn.commit()
        conn.close()
        print("This Database created successfully by - Mohammad naimul islam, C201049")